  ...
  render() {
    ...
    return (
        <Content>
          ...
          <Animatable.Text animation="slideInDown" easing="ease-out" iterationCount="infinite" direction="alternate" style={{ textAlign: 'center', color: 'white', fontSize: 50, paddingTop: 220}}>👇🏼</Animatable.Text>
